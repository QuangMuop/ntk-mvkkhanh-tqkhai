...
<script>
	$(document).ready(function() {
		...
		InitDisabledState();
                $('.request-edit').click(
			function(){
                                 $('#inputMaNhaSanXuat').attr('disabled', !$(this).is(':checked'));
                                 $('#inputTenNhaSanXuat').attr('disabled', !$(this).is(':checked'));   
    ...
    {
    	$('#inputMaNhaSanXuat').attr('disabled', true);
        $('#inputTenNhaSanXuat').attr('disabled', true);   
