...
public class ChiTietHoaDon  implements java.io.Serializable {
    ...
    public ChiTietHoaDon(long maChiTietHoaDon, DoChoi doChoi, HoaDon hoaDon, int soLuong, BigDecimal donGia, boolean daXoa) {
    ...
    public ChiTietHoaDon(long maChiTietHoaDon, DoChoi doChoi, HoaDon hoaDon, int soLuong, BigDecimal donGia, Date ngayCapNhat, boolean daXoa) {
       this.maChiTietHoaDon = maChiTietHoaDon;
       this.doChoi = doChoi;
       this.hoaDon = hoaDon;
       this.soLuong = soLuong;
