...
public class HoaDon  implements java.io.Serializable {
    ...
    public HoaDon(long maHoaDon, TaiKhoan taiKhoan, TrangThaiDonHang trangThaiDonHang, Date ngayLap, String tenKhachHang, String diaChiGiaoHang, boolean daXoa) {
    ...
    public HoaDon(long maHoaDon, TaiKhoan taiKhoan, TrangThaiDonHang trangThaiDonHang, Date ngayLap, String tenKhachHang, String diaChiGiaoHang, BigDecimal tongTien, Date ngayCapNhat, Boolean daThanhToan, boolean daXoa, Set chiTietHoaDons) {
       this.maHoaDon = maHoaDon;
       this.taiKhoan = taiKhoan;
       this.trangThaiDonHang = trangThaiDonHang;
       this.ngayLap = ngayLap;
